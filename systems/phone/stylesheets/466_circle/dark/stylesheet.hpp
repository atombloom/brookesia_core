...
constexpr Display::Data STYLESHEET_466_CIRCLE_DARK_DISPLAY_DATA = {
    ...
    .navigation_bar = {
        .data = STYLESHEET_466_CIRCLE_DARK_NAVIGATION_BAR_DATA,
        .visual_mode = NavigationBar::VisualMode::HIDE,
    },
    .app_launcher = {
        .data = STYLESHEET_466_CIRCLE_DARK_APP_LAUNCHER_DATA,
        .default_image = gui::StyleImage::IMAGE(&esp_brookesia_image_middle_app_launcher_default_112_112),
    },
    .recents_screen = {
        .data = STYLESHEET_466_CIRCLE_DARK_RECENTS_SCREEN_DATA,
...
constexpr Stylesheet STYLESHEET_466_CIRCLE_DARK = {
    ...
    .manager = STYLESHEET_466_CIRCLE_DARK_MANAGER_DATA,
};

} // namespace esp_brookesia::systems::phone

#define ESP_BROOKESIA_PHONE_466_CIRCLE_DARK_STYLESHEET() esp_brookesia::systems::phone::STYLESHEET_466_CIRCLE_DARK
